...
const STICKERS = [
  ...
  { id:"stk-046", src:"/stickers/sticker-eiffel_tower_watercolor.png",  name:"Eiffel Tower (Watercolor)", categories:["France","Paris","Travel","Landmark"] },
  { id:"stk-047", src:"/stickers/sticker-eiffel_tower_postage_stamp.png", name:"Eiffel Tower Postage Stamp", categories:["France","Paris","Travel","Landmark","Stamp"] },
  { id:"stk-048", src:"/stickers/sticker-eiffel_tower_gold.png",        name:"Eiffel Tower (Gold)",     categories:["France","Paris","Travel","Landmark"] },
  { id:"stk-049", src:"/stickers/sticker-arc_de_triomphe_watercolor.png", name:"Arc de Triomphe (Watercolor)", categories:["France","Paris","Travel","Landmark"] },
  { id:"stk-050", src:"/stickers/sticker-paris_script_heart.png",       name:"Paris Script with Heart", categories:["France","Paris","Travel","Text"] },
  { id:"stk-051", src:"/stickers/sticker-paris_postmark_stamp.png",     name:"Paris Postmark Stamp",    categories:["France","Paris","Travel","Stamp"] },
  { id:"stk-052", src:"/stickers/sticker-paris_airport_stamp.png",      name:"Paris Airport Stamp",     categories:["France","Paris","Travel","Stamp"] },
  { id:"stk-053", src:"/stickers/sticker-eiffel_tower_pink_sketch.png", name:"Eiffel Tower (Pink Sketch)", categories:["France","Paris","Travel","Landmark"] },
  { id:"stk-054", src:"/stickers/sticker-croissant_flat.png",           name:"Croissant (Flat)",        categories:["France","Paris","Food","Croissant"] },
  { id:"stk-055", src:"/stickers/sticker-macaron_pink.png",             name:"Macaron",                 categories:["France","Paris","Food","Macaron"] },
  { id:"stk-056", src:"/stickers/sticker-baguettes_bundle.png",         name:"Baguettes Bundle",        categories:["France","Paris","Food","Baguette"] },
  { id:"stk-057", src:"/stickers/sticker-croissant_watercolor.png",     name:"Croissant (Watercolor)",  categories:["France","Paris","Food","Croissant"] },
  { id:"stk-058", src:"/stickers/sticker-bonjour_script.png",           name:"Bonjour Script",          categories:["France","Paris","Travel","Text"] },
  { id:"stk-059", src:"/stickers/sticker-paris_bicycle.png",            name:"Paris Bicycle",           categories:["France","Paris","Travel","Bicycle"] },
  { id:"stk-060", src:"/stickers/sticker-beret_pink.png",               name:"Beret",                   categories:["France","Paris","Travel","Fashion"] },
  { id:"stk-061", src:"/stickers/sticker-i_love_paris.png",             name:"I Love Paris",            categories:["France","Paris","Travel","Text"] },
  { id:"stk-062", src:"/stickers/sticker-french_dog_baguette.png",      name:"French Dog with Baguette", categories:["France","Paris","Travel","Animal","Food"] },
  { id:"stk-063", src:"/stickers/sticker-boater_hat.png",               name:"Boater Hat",              categories:["France","Paris","Travel","Fashion"] },
  { id:"stk-064", src:"/stickers/sticker-paris_metro_sign.png",         name:"Paris Metro Sign",        categories:["France","Paris","Travel","Landmark"] },
  { id:"stk-065", src:"/stickers/sticker-tulip_bouquet.png",            name:"Tulip Bouquet",           categories:["France","Paris","Flower"] },
];
